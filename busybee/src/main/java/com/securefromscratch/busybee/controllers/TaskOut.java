...
public record TaskOut(UUID taskid, String name, String desc, Optional<LocalDate> dueDate, Optional<LocalTime> dueTime, String createdBy, String[] responsibilityOf,
                      @JsonFormat(pattern = "yyyy-MM-dd'T'HH:mm:ss") LocalDateTime creationDatetime, boolean done, TaskCommentOut[] comments) {
